...
AP1000_TLS_FRMIN = [
    VACCUM_LIGHT_SPEED / AP1000_TLS_WLMIN[0],
    None,
    VACCUM_LIGHT_SPEED / AP1000_TLS_WLMIN[2],
]
AP1000_TLS_FRMAX = [
    VACCUM_LIGHT_SPEED / AP1000_TLS_WLMAX[0],
    None,
    VACCUM_LIGHT_SPEED / AP1000_TLS_WLMAX[2],
]
...
# MIN AND MAX FREQUENCY
AP1000_DFB_FRMIN = [
    VACCUM_LIGHT_SPEED / AP1000_DFB_WLMIN[0],
    None,
    VACCUM_LIGHT_SPEED / AP1000_DFB_WLMIN[2],
    None,
    None,
    VACCUM_LIGHT_SPEED / AP1000_DFB_WLMIN[5],
]
AP1000_DFB_FRMAX = [
    VACCUM_LIGHT_SPEED / AP1000_DFB_WLMAX[0],
    None,
    VACCUM_LIGHT_SPEED / AP1000_DFB_WLMAX[2],
    None,
    None,
    VACCUM_LIGHT_SPEED / AP1000_DFB_WLMAX[5],
]
# FOR CALIBRATION ONLY
# MIN AND MAX TEMPERATURE BINARY VALUES
AP1000_DFB_TMIN = 0
