...
class AP2XXX:
    ...
    def Close(self):
        ...
        if self.__Simulation:
            ...
            try:
                ...
                raise ApexError(
                    APXXXX_ERROR_COMMUNICATION, self.Connexion.getsockname()[0]
                )
                sys.exit()
    ...
    def APEXTLS(self):
        ...
        Return a TLS object for using the Tunable Laser Source of the AP2XXX
        """
        from .apextls import TunableLaser
